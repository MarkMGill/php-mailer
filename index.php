   ...
   <body id="default_theme" class="home_page1">
         ...
         <div class="container">
            <div class="row">
               <div class="col-md-9 col-lg-10">
                  <div class="logo"><a href="index.php"><img src="images/SKYLIME HEADER - Copy.png" alt="#" /></a></div>
                  <div class="main_menu float-right">
                     <div class="menu">
                        <ul class="clearfix">
                           <li class="active"><a href="#">Home</a></li>
                           <li><a href="#about-us">About</a></li>
                           <li><a href="#about-services">Service</a></li>
               ...
               <!--   <div class="right_bt"><a class="bt_main" href="index.php">Get Support</a> </div>-->
               <!--</div>-->
            </div>
         </div>
      </header>
               ...
               <div class="col-md-6">
                  <div class="full">
                     <div class="slide_cont">
                        <h2>Familiarize Your Creative Services</h2>
                        <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium..!</p>
                        <div class="full slide_bt"> <a class="white_bt bt_main" href="index.php">Download</a> </div>
                     </div>
                  </div>
               </div>
               <div class="col-md-6">
      ...
      <section class="layout_padding padding_top_0">
         <div class="container">
            ...
            <div class="row margin_bottom_30 display-none">
               <!-- featured cont -->
               <div class="col-md-6 cont_theme_blog">
                  <div class="full">
            ...
            <div class="row">
               <div class="col-md-4">
                  <div class="information_blogs">
                     ...
                     <div class="imf_cont">
                        <p>
                           However, it is a pleasure to explain to you how all this mistaken prosecution tenour</p>
                     </div>
      ...
      <!-- end section -->
      <!-- section -->
      <section class="layout_padding layer_style" id="about-services">
         <div class="container">
            <div class="row">
               <div class="col-sm-12">
            ...
            <div class="row services-portfolio one">
               <div class="col-sm-6 service-img">
                  <img src="images/index.jpeg" alt="img">
               </div>
               <div class="col-sm-6 service-txt">
                  <span class="ul-heading">THERMAL PAPER ROLL</span>
                  <ul>
                     <li>1. 80X80 Thermal Receipt Printer Roll</li>
                     <li>2. 57X40 Thermal POS Roll</li>
                     <li>3. 57X40 Thermal POS Roll</li>
                     <li>4. 57X57 Thermal POS Roll</li>
                     <li>5. Carbonless Paper Roll 1ply and 2ply/li>
                     <li>6. ECG Paper Roll </li>
                     <li>7. Preprinted Thermal Paper Roll</li>
                  </ul>
               </div>
            </div>
            <div class="row services-portfolio two">
               <div class="col-sm-6 service-img">
                  <img class="barcode-img" src="images/barcode.jpeg" alt="img">
               </div>
               <div class="col-sm-6 servie-txt">
                  <span class="ul-heading">BARCODE LABELS</span>
                  <ul>
                     <li>
                        1. Direct Thermal Barcode Labels 50mmX25mm</li>
                     <li>
                        2. Direct Thermal Barcode Labels100mmX50mm</li>
                     <li>
                        3. Direct Thermal Barcode Labels 100mmX150mm</li>
                     <li>
                        4. Thermal Transfer Barcode Labels 50mmX25mm</li>
                     <li>
                        5. Thermal Transfer Barcode Labels 100mmX50mm</li>
                     <li>
                        6. Thermal Transfer Barcode Labels 100mmx150mm</li>
                     <li>
                        7. Pri-printed Labels (Customize Size) </li>
                     <li>
                        8. Other Customize Size Available.
                    </li>
                  </ul>
               </div>
            </div>
            <div class="row services-portfolio three">
               <div class="col-sm-6 service-img">
                  <img src="images/thermal.jpeg" alt="img">
               </div>
               <div class="col-sm-6 servie-txt">
                  <span class="ul-heading">THERMAL TRANSFER RIBBON</span>
                  <ul>
                     <li>
                        1. Wax Resin, Resin Ribbon 110mm X 300mtr</li>
                     <li>   
                        2. Wax Resin, Resin Ribbon 80mm X 300mtr</li>
                     <li>                       
                        3. Wax Resin, Resin Ribbon 110mm X 100mtr</li>
                     <li>                       
                        4. Wax Resin, Resin Ribbon 80 X 100mtr</li>
                     <li>
                        5. Other Customize Size Available.
                     </li>
                  </ul>
               </div>
            </div>
            <div class="row services-portfolio four">
               <div class="col-sm-6 service-img">
                  <img src="images/posprinters.jpeg" alt="img">
               </div>
               <div class="col-sm-6 servie-txt">
                  <span class="ul-heading">BARCODE AND POS PRINTERS</span>
                  <ul>
                     <li>
                    1. Zebra Barcode Printers </li>
                     <li>   
                    2. TSC Barcode Printers </li>
                     <li>                       
                    3. TSC Thermal POS Printer</li>
                     <li>                       
                    4. Citizen Barcode Printers</li>
                     <li>
                    5. Citizen Thermal Printers
                     </li>
                  </ul>
               </div>
            </div>
      ...
      <!-- end section -->
      <!-- section -->
      <section class="layout_padding table-disply-none">
         <div class="container">
            <div class="row">
               <div class="full">
                  <div class="row">
                     ...
                     <div class="row">
                        <div class="col-sm-12 col-md-4">
                           <div class="table_price text_align_center">
                              ...
                              <div class="table_price_bottm"> <a class="bt_main" href="index.php">Buy now</a> </div>
                           </div>
                        </div>
                        <div class="col-sm-12 col-md-4">
                           <div class="active_price table_price text_align_center">
                              ...
                              <div class="table_price_bottm"> <a class="reverse_bt bt_main" href="index.php">Buy now</a> </div>
                           </div>
                        </div>
                        <div class="col-sm-12 col-md-4">
                           <div class="table_price text_align_center">
               ...
               <div class="col-xs-12 col-sm-12 col-md-6" style="padding:0;">
                  <div class="full">
                     <div class="google-maps">
                         <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3671.986775261408!2d72.6634361141182!3d23.024257784952184!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x395e87aa54e9a1af%3A0x898a6d72ed9e3b9c!2sVK%20Complex!5e0!3m2!1sen!2sin!4v1597396869030!5m2!1sen!2sin"  frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
                     </div>
                  </div>
               </div>
               <div class="col-xs-12 col-sm-12 col-md-6" style="padding:0;" id="contact-us">
                  <div class="full">
                           ...
                           <div class="form_contact">
                              ...
                              <form method="post" action="index.php" enctype="multipart/form-data">
                                 <fieldset>
                                    ...
                                    <div class="field">
                                       <button class="field_bt" name="submit" type="submit">Send</button>
                                    </div>
                                 </fieldset>
                              </form>
                              <!-- end form -->
            ...
            <div class="container">
               <div class="row">
                  <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4 margin_bottom_30">
                     <div class="full width_9" style="margin-bottom:25px;"> <a href="index.php"><img class="img-responsive" width="250" src="images/logo.png" alt="#"></a> </div>
      ...
      <script>
         //document.querySelector('.field_bt').addEventListener('click', function(e) {
            //e.preventDefault();
        //});
